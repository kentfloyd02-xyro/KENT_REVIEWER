...
a:["Database Management","Application Development","System Analysis","Software Testing"],
c:1
},
{
...
a:["Entity Relationship Diagram","Flowchart","Data Flow Diagram","State Diagram"],
c:2
},{
...
a:["Flowchart","Data Flow Diagram","Entity Relationship Diagram","Sequence Diagram"],
c:2
},
{
...
a:["Sequence Diagram","Entity Relationship Diagram","State Transition Diagram","Data Flow Diagram"],
c:2
},
{
...
function selectAnswer(index) {
    ...
    if (index === q.c) {
        ...
        feedbackEl.innerHTML =
            `<p class='wrong'>Wrong! Correct answer: ${String.fromCharCode(65 + q.c)}. ${q.a[q.c]}</p>`;
    }
...
nextBtn.addEventListener("click", () => {
    ...
    if (currentQuestion < qs.length) {
        ...
        document.querySelector(".quiz").innerHTML =
            `<h2>Quiz Finished!</h2>
             <h3>Final Score: ${score}/${qs.length}</h3>`;
    }
});
